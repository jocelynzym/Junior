...
void PSRS(int *array, int n)
{
	...
	int leftover=n-base*num_threads;
...
#pragma omp parallel shared(base,array,n,i,p,pivot,count,leftover) private(id)
    {
...
int main()
{
    int array[31] = { 2,2,15,46,48,93,39,6,72,91,14,  36,69,40,89,61,97,12,21,54,  53,97,84,58,32,27,33,72,20,97,1 };
    PSRS(array, 31);
//    int test_merge[11]={3,97,84,58,32,27,33,72,20,97,1};
//    MergeSort(test_merge,0,10);
//    for(int i=0;i<11;i++)
//    cout<<test_merge[i]<<endl;
    return 0;
}
